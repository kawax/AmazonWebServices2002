...
<TABLE border="0" cellspacing="0" cellpadding="0"><tr valign="bottom" align="center"><td><xsl:text disable-output-escaping="yes">&#60;</xsl:text>A href="<xsl:value-of select="@url"/>" target="_top"<xsl:text disable-output-escaping="yes">&#62;</xsl:text><xsl:text disable-output-escaping="yes">&#60;</xsl:text>/A<xsl:text disable-output-escaping="yes">&#62;</xsl:text></td></tr> <tr valign="top" align="center"><td> <TABLE width="468" height="180" border="0" cellpadding="1" cellspacing="0" bgcolor="#616161"><TR><TD width="100%" height="100%"><TABLE width="466" height="178" border="0" cellpadding="0" cellspacing="0"><TR bgcolor="#FFFFFF"><TD align="center" valign="middle"><table cellpadding="2" cellspacing="0" border="0"><tr><td><table cellpadding="0" cellspacing="0" border="0"><tr>
<IMG src="http://rcm-images.amazon.com/images/G/01/rcm/468x60_banner.gif" width="468" height="60" border="0" alt="Amazon.com logo"/>
<xsl:for-each select="ProductInfo/Details">
<xsl:if test="position() &lt; 4">
<td><xsl:text disable-output-escaping="yes">&#60;</xsl:text>A href="<xsl:value-of select="@url"/>" target="_top"<xsl:text disable-output-escaping="yes">&#62;</xsl:text><xsl:text disable-output-escaping="yes">&#60;</xsl:text>img src="<xsl:value-of select="ImageUrlSmall"/>" border="0" vspace="2" hspace="2" alt="cover art"<xsl:text disable-output-escaping="yes">&#62;</xsl:text><xsl:text disable-output-escaping="yes">&#60;</xsl:text>/A<xsl:text disable-output-escaping="yes">&#62;</xsl:text></td><TD><xsl:text disable-output-escaping="yes">&#60;</xsl:text>A href="<xsl:value-of select="@url"/>" target="_top"<xsl:text disable-output-escaping="yes">&#62;</xsl:text><FONT face="Arial" size="-2" color="3366FF"><xsl:value-of select="ProductName"/></FONT><xsl:text disable-output-escaping="yes">&#60;</xsl:text>/A<xsl:text disable-output-escaping="yes">&#62;</xsl:text><br/><FONT face="Arial" size="-2" color="000000"><xsl:value-of select="Manufacturer"/></FONT><br/><font face="Arial" size="-2"><font color="990000">New <xsl:value-of select="OurPrice"/></font></font></TD>
</xsl:if>
</xsl:for-each>
</tr>
<tr>
