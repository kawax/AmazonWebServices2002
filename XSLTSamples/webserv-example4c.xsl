...
<TABLE border="0" cellspacing="0" cellpadding="0"><tr valign="bottom" align="center"><td><xsl:text disable-output-escaping="yes">&#60;</xsl:text>A href="<xsl:value-of select="@url"/>" target="_top"<xsl:text disable-output-escaping="yes">&#62;</xsl:text><xsl:text disable-output-escaping="yes">&#60;</xsl:text>/A<xsl:text disable-output-escaping="yes">&#62;</xsl:text></td></tr> <tr valign="top" align="center"><td> <TABLE width="120" height="60" border="0" cellpadding="1" cellspacing="0" bgcolor="#616161"><TR><TD width="100%" height="100%"><TABLE width="120" height="100" border="0" cellpadding="0" cellspacing="0"><TR bgcolor="#FFFFFF"><TD align="center" valign="middle"><table cellpadding="2" cellspacing="0" border="0"><tr><td><table cellpadding="0" cellspacing="0" border="0"><IMG src="http://rcm-images.amazon.com/images/G/01/rcm/120x60_banner.gif" width="135" border="0" alt="Amazon.com logo"/>
