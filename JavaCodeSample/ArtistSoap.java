...
public class ArtistSoap extends AbstractSoapQuery
{
 	public ArtistSoap()
 	{
 		super();
		this.parameters.put("Host","http://soap.amazon.com/onca/soap");
 		this.parameters.put("Artist","");
 	...
 	public Object issueRequest() throws MalformedURLException, ServiceException, RemoteException
 	{
		...
		com.amazon.soap.axis.ArtistRequest request = new com.amazon.soap.axis.ArtistRequest();


 		request.setArtist((String)this.parameters.get("Artist"));
		...
		request.setTag((String)this.parameters.get("Tag"));
 		...
 		this.result = port.artistSearchRequest(request);
 		return this.result;
 	}
