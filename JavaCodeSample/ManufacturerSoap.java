...
public class ManufacturerSoap extends AbstractSoapQuery
{
 	public ManufacturerSoap()
 	{
 		super();
		this.parameters.put("Host","http://soap.amazon.com/onca/soap");
 		this.parameters.put("Manufacturer","");
 	...
 	public Object issueRequest() throws MalformedURLException, ServiceException, RemoteException
 	{
		...
		com.amazon.soap.axis.ManufacturerRequest request = new com.amazon.soap.axis.ManufacturerRequest();


 		request.setManufacturer((String)this.parameters.get("Manufacturer"));
		...
		request.setTag((String)this.parameters.get("Tag"));
 		...
 		this.result = port.manufacturerSearchRequest(request);
 		return this.result;
 	}
